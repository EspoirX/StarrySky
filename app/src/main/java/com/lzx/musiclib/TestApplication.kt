...
open class TestApplication : Application() {
    ...
    class RequestSongInfoInterceptor internal constructor(private val mContext: Context) : StarrySkyInterceptor {
        ...
        override fun process(songInfo: SongInfo?, callback: InterceptorCallback) {
            ...
            SoulPermission.getInstance().checkAndRequestPermissions(Permissions.build(
                    ...
                    Manifest.permission.WRITE_EXTERNAL_STORAGE), object : CheckRequestPermissionsListener {
                override fun onAllPermissionOk(allPermissions: Array<Permission>) {
                    if (TextUtils.isEmpty(songInfo.songUrl)) {
                        mMusicRequest.requestSongUrl(songInfo.songId, object : RequestInfoCallback {
