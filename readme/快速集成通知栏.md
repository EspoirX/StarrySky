...
1. String targetClass              通知栏点击转跳界面，传入的是类的全路径
2. String contentTitle             通知栏标题
3. String contentText              通知栏内容
4. PendingIntent nextIntent        下一首按钮 PendingIntent,如果想自己实现下一首按钮点击，可设置这个
5. PendingIntent preIntent         上一首按钮 PendingIntent,功能同上
6. PendingIntent closeIntent       关闭按钮 PendingIntent,功能同上，closeIntent 的默认实现是 stopMusic()
7. PendingIntent playIntent        播放按钮 PendingIntent,功能同上
8. PendingIntent pauseIntent       暂停按钮 PendingIntent,功能同上
9. PendingIntent playOrPauseIntent 播放/暂停按钮 PendingIntent,功能同上
10. PendingIntent stopIntent       停止按钮 PendingIntent,功能同上
11. PendingIntent downloadIntent   下载按钮 PendingIntent
12. PendingIntent favoriteIntent   喜欢或收藏按钮 PendingIntent
13. PendingIntent lyricsIntent     桌面歌词按钮 PendingIntent，同 喜欢或收藏按钮
...
14. pendingIntentMode 设置通知栏点击模式  
有三种：MODE_ACTIVITY，MODE_BROADCAST，MODE_SERVICE  
分别对应 PendingIntent.getActivity()，PendingIntent.getBroadcast()，PendingIntent.getService()，默认是 PendingIntent.getActivity()

15. skipPreviousDrawableRes  
在系统通知栏中，上一首按钮的 drawable res，如果不传，则使用默认的 [drawable res](https://github.com/lizixian18/MusicLibrary/blob/StarrySkyJava/starrysky/src/main/res/drawable-xxhdpi/ic_skip_previous_white_24dp.png)

16. skipNextDrawableRes  
在系统通知栏中，下一首按钮的 drawable res，如果不传，则使用默认的 [drawable res](https://github.com/lizixian18/MusicLibrary/blob/StarrySkyJava/starrysky/src/main/res/drawable-xxhdpi/ic_skip_next_white_24dp.png)

17. pauseDrawableRes  
在系统通知栏中，正在播放时，播放按钮显示的 drawable res，如果不传，则使用默认的 [drawable res](https://github.com/lizixian18/MusicLibrary/blob/StarrySkyJava/starrysky/src/main/res/drawable-xxhdpi/ic_pause_white_24dp.png)

18. playDrawableRes  
在系统通知栏中，暂停状态时，播放按钮显示的 drawable res，如果不传，则使用默认的 [drawable res](https://github.com/lizixian18/MusicLibrary/blob/StarrySkyJava/starrysky/src/main/res/drawable-xxhdpi/ic_play_arrow_white_24dp.png)

19. smallIconRes  
对应通知栏的 smallIcon，不传则使用默认的 [smallIcon](https://github.com/lizixian18/MusicLibrary/blob/StarrySkyJava/starrysky/src/main/res/drawable-xxhdpi/ic_notification.png)
